...
MAX_GAMES: int = 500            # Total number of games to train
...
EPSILON_DECAY: int = 80         # Base for epsilon decay: epsilon = max(EPSILON_DECAY - n_games, 0)

# Model saving/loading configuration
MODEL_FOLDER: str = "Model Folder File Path"  # Path to the model folder
