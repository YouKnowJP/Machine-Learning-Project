...
def load_data():
    ...
    """
    # Load training set
    train_df = pd.read_csv("/Users/youknowjp/PycharmProjects/Machine-Learning-Project/CNN-From-Scratch/digit-recognizer/train.csv")
    X_train = train_df.drop(columns=["label"]).values
    y_train = train_df["label"].values

    # Load testing set
    test_df = pd.read_csv("/Users/youknowjp/PycharmProjects/Machine-Learning-Project/CNN-From-Scratch/digit-recognizer/test.csv")
